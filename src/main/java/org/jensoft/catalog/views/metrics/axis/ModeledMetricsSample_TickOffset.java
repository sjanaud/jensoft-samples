...
public class ModeledMetricsSample_TickOffset extends View {

	private static final long serialVersionUID = 7844944428314168114L;

	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new ModeledMetricsSample_TickOffset());
	}
	/**
	 * create the modeled metrics demo
	 */
	public ModeledMetricsSample_TickOffset() {
		super();

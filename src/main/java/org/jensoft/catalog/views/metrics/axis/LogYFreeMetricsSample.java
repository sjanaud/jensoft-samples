...
public class LogYFreeMetricsSample extends View {

	private static final long serialVersionUID = 2924327345924171007L;

	public LogYFreeMetricsSample() {
		...
		TitleLegend legend = new TitleLegend("Free Log Y Metrics");
	...
	@Portfolio(name = "Metrics-LogY-Free", width = 500, height = 250)
	public static View getPortofolio() {
		LogYFreeMetricsSample demo = new LogYFreeMetricsSample();

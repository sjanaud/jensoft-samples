...
public class ModeledMetricsSample_Suffix extends View {

	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new ModeledMetricsSample_Suffix());
	}
	
	/**
	 * create the modeled metrics demo
	 */
	public ModeledMetricsSample_Suffix() {
		super();

...
public class PiePlugin_Effect_Cubic_view16 extends View {

	private static final long serialVersionUID = -9058184342303461266L;

	public PiePlugin_Effect_Cubic_view16() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Wave2.getKeyFrame());		

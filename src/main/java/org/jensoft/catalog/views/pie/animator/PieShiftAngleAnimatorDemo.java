...
import org.jensoft.core.plugin.pie.animator.PieShiftStartAngleAnimator;
import org.jensoft.core.plugin.pie.animator.PieShiftStartAngleAnimator.ShiftVelocity;
...
@JenSoftView(description="Pie with an angle shift animator.")
public class PieShiftAngleAnimatorDemo extends View {

	private static final long serialVersionUID = 7932605065688768038L;

	public PieShiftAngleAnimatorDemo() {
		super();
		...
		final PieShiftStartAngleAnimator shift = new PieShiftStartAngleAnimator();

		pie.addPieAnimator(shift);

		shift.shift(ShiftVelocity.Speed);
		shift.interruptShiftingAfter(6000);
	}
}

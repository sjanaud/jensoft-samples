 ...
 */
package org.jensoft.catalog.views.pie.multiple;
...
@JenSoftView(description="Show how to create multiple pie.")
public class PieMultiple1LabelDemo extends View {
	
	private static final long serialVersionUID = 6733376896438257520L;

	public PieMultiple1LabelDemo() {
		super(0);
		Projection.Linear proj = new Projection.Linear(-4, 4, -4, 4);

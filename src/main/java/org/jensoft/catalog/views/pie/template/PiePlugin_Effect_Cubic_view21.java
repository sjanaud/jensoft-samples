...
public class PiePlugin_Effect_Cubic_view21 extends View {

	private static final long serialVersionUID = -7502856672578333492L;

	public PiePlugin_Effect_Cubic_view21() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Moon1.getKeyFrame());		

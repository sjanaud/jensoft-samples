...
public class PiePlugin_Effect_Cubic_view22 extends View {

	private static final long serialVersionUID = -1623356269423063805L;

	public PiePlugin_Effect_Cubic_view22() {
		super(2);
		...
		Pie pie = new Pie();
		pie.setRadius(70);
		// pie.setPieDraw(new PieDefaultDraw(Color.WHITE));
		...
		cubicFX.setCubicKey(CubicEffectFrame.Moon2.getKeyFrame());
		cubicFX.setFrame(CubicEffectFrame.Moon2);

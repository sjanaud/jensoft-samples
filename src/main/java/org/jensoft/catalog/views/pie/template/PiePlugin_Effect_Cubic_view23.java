...
public class PiePlugin_Effect_Cubic_view23 extends View {

	private static final long serialVersionUID = 1296678304795281508L;

	public PiePlugin_Effect_Cubic_view23() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Moon3.getKeyFrame());		

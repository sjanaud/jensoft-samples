...
import org.jensoft.core.plugin.pie.animator.PieAlphaAnimator;
 ...
 *
 */
@JenSoftView(description="Pie with an alpha animator.")
public class PieAlphaAnimatorDemo extends View {

	private static final long serialVersionUID = 5636412618508048362L;

	public PieAlphaAnimatorDemo() {
		super();
		...
		pie.addPieAnimator(new PieAlphaAnimator(0.1f, 1f));
	}
}

...
public class PiePlugin_Effect_Cubic_view20 extends View {

	private static final long serialVersionUID = 6173569498911476507L;

	public PiePlugin_Effect_Cubic_view20() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Wave6.getKeyFrame());		

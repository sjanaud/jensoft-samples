...
public class PiePlugin_Effect_Cubic_view24 extends View {

	private static final long serialVersionUID = -480682740090734438L;

	public PiePlugin_Effect_Cubic_view24() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Moon4.getKeyFrame());		

...
public class PiePlugin_Effect_Cubic_view18 extends View {

	private static final long serialVersionUID = -1694703181686474135L;

	public PiePlugin_Effect_Cubic_view18() {
		super(2);
		...
		cubicFX.setCubicKey(CubicEffectFrame.Wave4.getKeyFrame());		
		pie.setPieEffect(cubicFX);
		

		PieSlice s1 = new PieSlice("s1", RosePalette.FOXGLOWE);
		s1.setValue(45);
		s1.setDivergence(0);

		PieSlice s2 = new PieSlice("s2", Spectral.SPECTRAL_PURPLE1);
		s2.setValue(8.0);
		s2.setDivergence(0);

		PieSlice s3 = new PieSlice("s3", Spectral.SPECTRAL_PURPLE2);
		s3.setValue(15.0);
		s3.setDivergence(0);


		PieSlice s4 = new PieSlice("s4", Spectral.SPECTRAL_BLUE1);
		s4.setValue(30.0);
		s4.setDivergence(0);

...
@JenSoftView(description="Show how to use pie slice draw.")
public class PieSliceDraw1Demo extends View {

	private static final long serialVersionUID = -7513782347357340308L;

	public PieSliceDraw1Demo() {
		super(0);
		...
		PieSliceDefaultDraw draw = new PieSliceDefaultDraw();
		draw.setDrawColor(RosePalette.MELON);
		draw.setDrawStroke(new BasicStroke(1.4f));

		s3.setSliceDraw(draw);
		s3.setDivergence(10);

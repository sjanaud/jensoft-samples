...
/**
 * <code>AreaMultipleSplineYFunctionPeakTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with multiple lines based on spline y function with peak tracker")
public class AreaMultipleSplineYFunctionPeakTracker extends View {

	private static final long serialVersionUID = 3259842896910233461L;

	/**
	 * Create demo with multiple area function with peack tracker
	 */
	public AreaMultipleSplineYFunctionPeakTracker() {
		super(50);

...
/**
 * <code>CurveLineYFunctionSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use curve line y function")
public class CurveLineYFunctionSample extends View {

	private static final long serialVersionUID = 4711090530674737744L;

	/**
	 * create curve function sample view
	 */
	public CurveLineYFunctionSample() {
		super();
		setPlaceHolder(40);
		...
		UserSourceFunction source = new UserSourceFunction.LineSource(xValues, yValues, FunctionNature.YFunction);
		...
		TitleLegend legend = new TitleLegend("Simple Line Y Function");
		legend.setFont(f);

...
/**
 * <code>ScatterLineYFunction</code>
 * 
 * @author Sébastien Janaud
 * 
 */
@JenSoftView(background=ViewDarkBackground.class,description="Shwo to use scatter line y function")
public class ScatterLineYFunction extends View {

	private static final long serialVersionUID = 3448684808326677844L;
	...
	public ScatterLineYFunction() {
		...
		TitleLegend legend = new TitleLegend("Line Y Scatter");

...
/**
 * <code>AreaSimpleSplineYFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with spline line based on spline y function")
public class AreaSimpleSplineYFunction extends View {

	private static final long serialVersionUID = 6167062880228447990L;

	/**
	 * Create a basic spline area function
	 */
	public AreaSimpleSplineYFunction() {
		super(50);

		// proj projection
		Projection proj = new Projection.Linear(-1, 11, 0, 10);
		registerProjection(proj);
		proj.setThemeColor(NanoChromatique.ORANGE);
		...
		UserSourceFunction source = new UserSourceFunction.SplineSource(xValues1, yValues1,FunctionNature.YFunction, 0.1);
		...
		TitleLegend legend = new TitleLegend("Spline X Area");
	 ...
	 */
	@Portfolio(name = "Function-Area-SplineY", width = 600, height = 400)
	public static View getPortofolio() {
		AreaSimpleSplineYFunction demo = new AreaSimpleSplineYFunction();

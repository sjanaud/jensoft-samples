...
/**
 * <code>ScatterMultipleYFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Shwo to use multiple scatter spline y function")
public class ScatterMultipleSplineYFunction extends View {

	private static final long serialVersionUID = 9118021398869763986L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleSplineYFunction() {
		super();
		...
		TitleLegend legend = new TitleLegend("Multiple Spline Y Scatter");

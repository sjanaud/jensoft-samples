 ...
 * 
 */
@JenSoftView(background=ViewDarkBackground.class,description="Shwo to use scatter line x function")
public class ScatterLineXFunction extends View {

	private static final long serialVersionUID = 8227448522956865393L;
	...
	public ScatterLineXFunction() {
		...
		TitleLegend legend = new TitleLegend("Line X Scatter");

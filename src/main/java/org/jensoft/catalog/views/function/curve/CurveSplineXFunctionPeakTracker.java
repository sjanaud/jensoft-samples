...
/**
 * <code>CurveSplineXFunctionPeakTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use curve spline x function with peak tracker")
public class CurveSplineXFunctionPeakTracker extends View {

	private static final long serialVersionUID = 4437445824773907915L;

	/**
	 * create curve function sample view
	 */
	public CurveSplineXFunctionPeakTracker() {
		super();
		setPlaceHolder(40);

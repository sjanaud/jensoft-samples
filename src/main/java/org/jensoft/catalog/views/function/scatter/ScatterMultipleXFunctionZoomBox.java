...
/**
 * <code>ScatterMultipleXFunctionZoomBox</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use multiple scatter x function with zoom box")
public class ScatterMultipleXFunctionZoomBox extends View {

	private static final long serialVersionUID = -8856509499385988831L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleXFunctionZoomBox() {
		super();
		...
		TitleLegend legend = new TitleLegend("Scatter X Zoom Box");

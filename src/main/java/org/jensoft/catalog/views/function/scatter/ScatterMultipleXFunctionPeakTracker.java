...
/**
 * <code>ScatterMultipleXFunctionPeakTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use multiple scatter x function with peak tracker")
public class ScatterMultipleXFunctionPeakTracker extends View {

	private static final long serialVersionUID = 5734257140865855846L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleXFunctionPeakTracker() {
		super();
		...
		TitleLegend legend = new TitleLegend("Scatter X Peak Tracker");

...
/**
 * <code>ScatterMultipleLineYFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Shwo to use multiple scatter line y function")
public class ScatterMultipleLineYFunction extends View {

	private static final long serialVersionUID = -4537667733898937338L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleLineYFunction() {
		super();
		...
		TitleLegend legend = new TitleLegend("Multiple Line Y Scatter");

...
/**
 * <code>AreaSimpleLineYFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with simple line based on line y function")
public class AreaSimpleLineYFunction extends View {

	private static final long serialVersionUID = 8903428439116821783L;

	/**
	 * Create a basic line area function
	 */
	public AreaSimpleLineYFunction() {
		super(50);

		// proj projection
		Projection proj = new Projection.Linear(0, 10, 0, 10);
		registerProjection(proj);
		proj.setThemeColor(NanoChromatique.ORANGE.brighter());
		...
		// source function
		double[] yValues1 = { 0, 1, 2, 3, 4, 5.2, 6, 7, 8, 9, 10 };
		double[] xValues1 = { 3, 1, 5, 4, 4.8, 7.3, 2, 3, 7, 10, 6 };
		UserSourceFunction source = new UserSourceFunction.LineSource(xValues1, yValues1, FunctionNature.YFunction);

		// area function
		Area area = new Area(source);
		area.setAreaFill(new AreaGradientFill());
		area.setAreaDraw(new AreaDefaultDraw(Color.WHITE, new BasicStroke(1f)));
		area.setThemeColor(FilPalette.YELLOW2.brighter());
		area.setAreaBase(0);
		...
		TitleLegend legend = new TitleLegend("Line Y Area");
		legend.setLegendFill(new TitleLegendGradientFill(Color.WHITE, FilPalette.YELLOW1));
		legend.setFont(f);
	 ...
	 */
	@Portfolio(name = "Function-Area-LineY", width = 600, height = 400)
	public static View getPortofolio() {
		AreaSimpleLineYFunction demo = new AreaSimpleLineYFunction();

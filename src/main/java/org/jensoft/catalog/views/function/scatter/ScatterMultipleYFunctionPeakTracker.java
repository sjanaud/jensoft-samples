...
/**
 * <code>ScatterMultipleYFunctionPeakTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use multiple scatter y function with peak tracker")
public class ScatterMultipleYFunctionPeakTracker extends View {

	private static final long serialVersionUID = 2058746275732494067L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleYFunctionPeakTracker() {
		super();
		...
		TitleLegend legend = new TitleLegend("Scatter Y Peak Tracker");

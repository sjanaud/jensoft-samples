 ...
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use multiple scatter y function with source tracker")
public class ScatterMultipleYFunctionSourceTracker extends View {

	private static final long serialVersionUID = -7081009098151832078L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleYFunctionSourceTracker() {
		super();

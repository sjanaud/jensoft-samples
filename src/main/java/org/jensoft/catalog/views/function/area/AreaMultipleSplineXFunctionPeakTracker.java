...
/**
 * <code>AreaMultipleSplineXFunctionPeakTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with multiple lines based on spline x function with peak tracker")
public class AreaMultipleSplineXFunctionPeakTracker extends View {

	private static final long serialVersionUID = 8034559542606810097L;

	/**
	 * Create demo with multiple area function with peack tracker
	 */
	public AreaMultipleSplineXFunctionPeakTracker() {
		super(50);
		...
		// legend plug-in
		TitleLegend legend = new TitleLegend("Area Peak Tracker");

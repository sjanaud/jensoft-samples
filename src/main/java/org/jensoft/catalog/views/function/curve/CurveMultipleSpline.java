...
/**
 * <code>CurveMultipleSpline</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use curve multiple spline function")
public class CurveMultipleSpline extends View {

	private static final long serialVersionUID = -2617972374353297901L;

	/**
	 * create curve function sample view
	 */
	public CurveMultipleSpline() {
		super();
		setPlaceHolder(40);
		...
		UserSourceFunction source4 = new UserSourceFunction.SplineSource(xValues4, yValues4, 0.1);

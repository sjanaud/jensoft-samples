...
/**
 * <code>ScatterMultipleXFunctionSourceTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use multiple scatter x function with source tracker")
public class ScatterMultipleXFunctionSourceTracker extends View {

	private static final long serialVersionUID = -3481171377158516863L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleXFunctionSourceTracker() {
		super();
		...
		scatter2.setThemeColor(RosePalette.FLANNELGRAY);
		...
		scatter3.setThemeColor(RosePalette.LEAFGREEN);
		...
		TitleLegend legend = new TitleLegend("Scatter X Source Tracker");

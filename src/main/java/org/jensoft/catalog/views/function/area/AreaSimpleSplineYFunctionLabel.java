...
/**
 * <code>AreaSimpleSplineYFunctionLabel</code>
 * 
...
public class AreaSimpleSplineYFunctionLabel extends View {

	private static final long serialVersionUID = -2977485067874272446L;

	/**
	 * Create area function with label
	 */
	public AreaSimpleSplineYFunctionLabel() {
		super(50);

		// proj projection
		Projection proj = new Projection.Linear(-1, 14, 0, 6);
		...
		area.setAreaDraw(new AreaDefaultDraw(Color.WHITE, Color.WHITE));
		area.setThemeColor(RosePalette.LEAFGREEN);
		area.setAreaBase(0);
		...
		metric.setGlyphMetricFill(new GlyphFill(Color.WHITE, RosePalette.LIME));
		metric.setGlyphMetricMarkerPainter(new RoundMarker(RosePalette.LIME, Color.white));
		metric.setFont(f);
		...
		legend.setLegendFill(new TitleLegendGradientFill(Color.WHITE, RosePalette.LIME));
		legend.setFont(f);
	 ...
	 */
	@Portfolio(name = "Function-Area-SplineY-Label", width = 600, height = 400)
	public static View getPortofolio() {
		AreaSimpleSplineYFunctionLabel demo = new AreaSimpleSplineYFunctionLabel();

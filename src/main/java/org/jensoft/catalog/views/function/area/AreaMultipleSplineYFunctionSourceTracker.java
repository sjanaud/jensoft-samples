...
/**
 * <code>AreaMultipleSplineYFunctionSourceTracker</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with multiple lines based on spline y function with source tracker")
public class AreaMultipleSplineYFunctionSourceTracker extends View {

	private static final long serialVersionUID = -480368618570971559L;

	/**
	 * Create area function demo with source function tracker
	 */
	public AreaMultipleSplineYFunctionSourceTracker() {
		super(50);

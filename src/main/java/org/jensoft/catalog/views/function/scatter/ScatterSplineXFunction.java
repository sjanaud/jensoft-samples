...
/**
 * <code>ScatterSplineXFunction</code>
 * 
 * @author Sébastien Janaud
 * 
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use scatter x function")
public class ScatterSplineXFunction extends View {

	private static final long serialVersionUID = 6511459149951778408L;
	...
	public ScatterSplineXFunction() {
		...
		UserSourceFunction source = new UserSourceFunction.SplineSource(xValues1, yValues1, 0.3);
		...
		TitleLegend legend = new TitleLegend("Spline X Scatter");

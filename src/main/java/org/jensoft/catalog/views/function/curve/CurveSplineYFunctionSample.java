...
/**
 * <code>CurveSplineYFunctionSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use curve spline y function")
public class CurveSplineYFunctionSample extends View {

	private static final long serialVersionUID = 2619789963305774555L;

	/**
	 * create curve function sample view
	 */
	public CurveSplineYFunctionSample() {
		super();
		setPlaceHolder(40);

		// proj projection
		Projection proj = new Projection.Linear(-3.1, 18.2, -1.5, 12.5);
		...
		Curve curve = FunctionToolkit.createCurveFunction(sourceFunction, NanoChromatique.BLUE.brighter(), new CurveDefaultDraw());
		curveFunctions.addFunction(curve);

		// legend
		Font f =  new Font("Dialog", Font.PLAIN, 12);
		TitleLegend legend = new TitleLegend("Simple spline Y function");
		legend.setFont(f);

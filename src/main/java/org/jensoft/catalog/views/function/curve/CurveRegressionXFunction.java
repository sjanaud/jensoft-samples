...
/**
 * <code>CurveRegressionXFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show ho to use curve with regression x function")
public class CurveRegressionXFunction extends View {

	private static final long serialVersionUID = -354648063435355934L;

	/**
	 * create curve function sample view
	 */
	public CurveRegressionXFunction() {
		super();
		setPlaceHolder(40);
		...
		UserSourceFunction source = new UserSourceFunction.RegressionSource(xValues, yValues, 0.1);
		...
		TitleLegend legend = new TitleLegend("Simple regression X function");
		legend.setFont(f);

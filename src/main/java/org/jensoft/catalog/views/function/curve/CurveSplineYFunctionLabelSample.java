...
/**
 * <code>CurveSplineYFunctionLabelSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Show how to use curve spline y function with labels")
public class CurveSplineYFunctionLabelSample extends View {

	private static final long serialVersionUID = 7580957930331829564L;

	/**
	 * create curve function sample view
	 */
	public CurveSplineYFunctionLabelSample() {
		super();
		setPlaceHolder(40);
		...
		SplineSource sourceFunction = new SplineSource(xValues, yValues, FunctionNature.YFunction, 0.1);

		// curve function
		Curve curve = FunctionToolkit.createCurveFunction(sourceFunction, NanoChromatique.PINK, new CurveDefaultDraw());
		curveFunctions.addFunction(curve);

		// legend
		Font f =  new Font("Dialog", Font.PLAIN, 12);
		TitleLegend legend = new TitleLegend("Spline Y and Label");
		legend.setFont(f);
		legend.setLegendFill(new TitleLegendGradientFill(FilPalette.BLUE15, FilPalette.BLUE1));
		...
		g2.setValue(2.5);
		g2.setGlyphMetricFill(new GlyphFill(FilPalette.PINK1, FilPalette.PURPLE1));
		// g1.setFont(InputFonts.getFont(InputFonts.NEUROPOL,12));
		...
		g3.setDivergence(15);
		g3.setGlyphMetricMarkerPainter(new TicTacMarker(FilPalette.PINK1, 1, 0, 10));

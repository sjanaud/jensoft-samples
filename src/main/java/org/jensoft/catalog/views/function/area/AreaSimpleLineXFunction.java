...
/**
 * <code>AreaSimpleLineXFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with simple line based on line x function")
public class AreaSimpleLineXFunction extends View {

	private static final long serialVersionUID = 4083554594087633098L;

	/**
	 * Create a basic line area function
	 */
	public AreaSimpleLineXFunction() {
		super(50);

		// proj projection
		Projection proj = new Projection.Linear(1, 9, 0, 12);
		...
		UserSourceFunction source = new UserSourceFunction.LineSource(xValues1, yValues1);
		...
		area.setThemeColor(FilPalette.BLUE12);
		area.setAreaBase(0);
		...
		TitleLegend legend = new TitleLegend("Line X Area");
	 ...
	 */
	@Portfolio(name = "Function-Area-LineX", width = 600, height = 400)
	public static View getPortofolio() {
		AreaSimpleLineXFunction demo = new AreaSimpleLineXFunction();

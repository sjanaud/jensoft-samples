...
/**
 * <code>AreaSimpleSplineXFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with spline line based on spline x function")
public class AreaSimpleSplineXFunction extends View {

	private static final long serialVersionUID = 1692254583346063395L;
 public static void main(String[] args) {
	ViewFrameUI ui = new  ViewFrameUI(new AreaSimpleSplineXFunction());
}
	/**
	 * Create a basic spline area function
	 */
	public AreaSimpleSplineXFunction() {
		super(50);

		// proj projection
		Projection proj = new Projection.Linear(0, 10, 0, 18);
		registerProjection(proj);
		proj.setThemeColor(FilPalette.GREEN5);
		...
		area.setThemeColor(RosePalette.AZALEA);
		area.setAreaBase(0);
	 ...
	 */
	@Portfolio(name = "Function-Area-SplineX", width = 600, height = 400)
	public static View getPortofolio() {
		AreaSimpleSplineXFunction demo = new AreaSimpleSplineXFunction();

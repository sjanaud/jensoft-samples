...
/**
 * <code>ScatterMultipleXFunction</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Shwo to use multiple scatter spline x function")
public class ScatterMultipleSplineXFunction extends View {

	private static final long serialVersionUID = 2433234108687399201L;
	 ...
	 * Create scatter view
	 */
	public ScatterMultipleSplineXFunction() {
		super();
		...
		UserSourceFunction source1 = new UserSourceFunction.SplineSource(xValues1, yValues1, 0.3);
		UserSourceFunction source2 = new UserSourceFunction.SplineSource(xValues2, yValues2, 0.3);
		UserSourceFunction source3 = new UserSourceFunction.SplineSource(xValues3, yValues3, 0.3);
		...
		TitleLegend legend = new TitleLegend("Multiple Spline X Scatter");
	 ...
	 */
	@Portfolio(name = "Function-Scatter-Multiple-SplineX", width = 800, height = 600)
	public static View getPortofolio() {
		ScatterMultipleSplineXFunction demo = new ScatterMultipleSplineXFunction();

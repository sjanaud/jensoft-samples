 ...
 */
@JenSoftView(background=ViewDarkBackground.class,description="Area with multiple lines based on line x function")
public class AreaMultipleLineXFunction extends View {
	...
	public AreaMultipleLineXFunction() {
		...
		// legend 
		TitleLegend legend = new TitleLegend("Areas functions");
	 ...
	 */
	@Portfolio(name = "Function-Area-Multiple-LineX", width = 600, height = 400)
	public static View getPortofolio() {
		AreaMultipleLineXFunction demo = new AreaMultipleLineXFunction();

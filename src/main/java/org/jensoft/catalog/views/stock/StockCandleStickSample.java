 ...
 */
@JenSoftView(background = ViewDarkBackground.class, description = "Display stock candles stick charts")
public class StockCandleStickSample extends View {

	
	private static final long serialVersionUID = -2505926780542878337L;
	...
	public static List<Stock> loadStockData() {
		...
		try {
			InputStream is = StockCandleStickSample.class.getResourceAsStream("slv-2003-2013.csv");
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new StockCandleStickSample());
	}

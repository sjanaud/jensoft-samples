...
/**
 * <code>StockFixingCurveSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background = ViewDarkBackground.class, description = "Display stock fixing charts based on close value and fixing time")
public class StockFixingCurveSample extends View {

	private static final long serialVersionUID = 8426987141425206801L;
	...
	/**
	 * Create stock fixing chart
	 */
	public StockFixingCurveSample() {
		super();
		...
		stockPlugin.addLayer(new StockLayer.FixingCurve());
	...
	public static List<Stock> loadStockData() {
		...
		try {
			InputStream is = StockFixingCurveSample.class.getResourceAsStream("slv-2013.csv");
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new StockFixingCurveSample());
	}

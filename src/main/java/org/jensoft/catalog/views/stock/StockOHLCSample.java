...
/**
 * <code>StockCandleStickSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background = ViewDarkBackground.class, description = "Display stock OHLC stick charts")
public class StockOHLCSample extends View {

	private static final long serialVersionUID = 4631540092424626843L;
	...
	public StockOHLCSample() {
		...
		stockPlugin.addLayer(new StockLayer.Ohlc());
	...
	public static List<Stock> loadStockData() {
		...
		try {
			InputStream is = StockOHLCSample.class.getResourceAsStream("slv-2013.csv");
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new StockOHLCSample());
	}

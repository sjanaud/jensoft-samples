...
/**
 * <code>StockMovingAverageCurveSample</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background = ViewDarkBackground.class, description = "Display stock simple moving average charts")
public class StockMovingAverageCurveSample extends View {
	 ...
	 */
	public StockMovingAverageCurveSample() {
		super();
	...
	public static List<Stock> loadStockData() {
		...
		try {
			InputStream is = StockMovingAverageCurveSample.class.getResourceAsStream("slv-2013.csv");
	...
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new StockMovingAverageCurveSample());
	}

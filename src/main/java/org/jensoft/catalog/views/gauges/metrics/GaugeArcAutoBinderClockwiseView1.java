...
/**
 * <code>GaugeArcAutoBinderClockwiseView1</code>
 * 
 * @author Sébastien Janaud
 * 
 */
@JenSoftView(background = ViewDarkBackground.class, description = "Gauge arc path auto binder in clockwise mode. This sample show how to use arc auto path binder to design gauge metrics.",
				see={PathBinder.class,PathArcAutoBinder.class,PathArcManualBinder.class})
public class GaugeArcAutoBinderClockwiseView1 extends View {

	private static final long serialVersionUID = 870164250611475302L;

	
	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new GaugeArcAutoBinderClockwiseView1());
	}
	...
	private class GaugeArcAutoBinder extends RadialGauge {
		public GaugeArcAutoBinder() {
			...
			AbstractPathAutoBinder binder = new PathArcAutoBinder(120, 140, 30);
	...
	public GaugeArcAutoBinderClockwiseView1() {
		super(20);

...
public class GaugeQuadraticAutoBinderAntiClockwiseDemo extends View {
	...
	private class GaugeArcAutoBinder extends RadialGauge {
		public GaugeArcAutoBinder() {
			...
			AbstractPathAutoBinder binder = new PathQuadAutoBinder(120, 140, 30,Direction.AntiClockwise);
	...
	public GaugeQuadraticAutoBinderAntiClockwiseDemo() {
		super(20);

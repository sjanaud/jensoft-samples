...
public class GaugeCubicAutoBinderAntiClockwiseDemo extends View {

	private static final long serialVersionUID = -2883308274556575849L;

	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new GaugeCubicAutoBinderAntiClockwiseDemo());
	}
	private class GaugeArcAutoBinder extends RadialGauge {
		public GaugeArcAutoBinder() {
			...
			AbstractPathAutoBinder binder = new PathCubicAutoBinder(120, 140, 30,Direction.AntiClockwise);
	...
	public GaugeCubicAutoBinderAntiClockwiseDemo() {
		super(20);

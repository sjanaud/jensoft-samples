...
public class Stripe3ColorsSample extends View {

	@Portfolio(name = "Stripe-Multiplier-2", width = 500, height = 250)
	public static View getPortofolio() {
		Stripe3ColorsSample demo = new Stripe3ColorsSample();
	...
	public Stripe3ColorsSample() {
		...
		bp.addPaint(ColorPalette.alpha(TangoPalette.SKYBLUE3, 80));

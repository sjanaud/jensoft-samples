...
public class StripeMultiplierSample extends View {

	@Portfolio(name = "Stripe-Multiplier-1", width = 500, height = 250)
	public static View getPortofolio() {
		StripeMultiplierSample demo = new StripeMultiplierSample();

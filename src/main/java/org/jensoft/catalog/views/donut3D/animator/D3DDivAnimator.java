...
import org.jensoft.core.plugin.donut3d.animator.Donut3DDivergenceAnimator;
...
/**
 * <code>D3DDivAnimator</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use slice divergence animator on donut3D slice.")
public class D3DDivAnimator extends View {

	private static final long serialVersionUID = 6759712845016364054L;

	/**
	 * create Donut3D demo with divergence animator
	 */
	public D3DDivAnimator() {
		// create the view with no axis place holder
		super(0);

		// create a proj projection
		...
		// a Donut3D has default center point P(0,0) and is project in user
		// coordinate
		...
		// add slices to donut3D or add all with toolkit
		Donut3DToolkit.pushSlices(donut3d, s1, s2, s3, s4);

		// create donut3D label
		...
		// add divergence animator
		donut3DPlugin.addDonutAnimator(new Donut3DDivergenceAnimator(60, 2));
	}
}

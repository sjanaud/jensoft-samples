...
/**
 * <code>Donut3DPlugin_Label_Radial_view1</code>
 * 
 * @author JenSoftAPI
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use radial label on donut3D slice.")
public class Donut3DPlugin_Label_Radial_view1 extends View {

	private static final long serialVersionUID = -2553524882466114328L;

	/**
	 * Create Donut3D radial label demo
	 */
	public Donut3DPlugin_Label_Radial_view1() {
		super(0);

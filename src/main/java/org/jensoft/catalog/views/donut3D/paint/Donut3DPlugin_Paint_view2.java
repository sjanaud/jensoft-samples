...
/**
 * <code>Donut3DPlugin_Paint_view2</code>
 * 
 * @author JenSoftAPI
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to paint for donut3D.")
public class Donut3DPlugin_Paint_view2 extends View {

	private static final long serialVersionUID = 4137350564390578941L;

	/**
	 * Create Donut3D radial label demo
	 */
	public Donut3DPlugin_Paint_view2() {
		super(0);

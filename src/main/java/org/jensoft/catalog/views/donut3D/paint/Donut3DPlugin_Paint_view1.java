...
/**
 * <code>Donut3DPlugin_Paint_view1</code>
 * 
 * @author JenSoftAPI
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to paint for donut3D.")
public class Donut3DPlugin_Paint_view1 extends View {

	private static final long serialVersionUID = -3311873209974593409L;

	/**
	 * Create Donut3D radial label demo
	 */
	public Donut3DPlugin_Paint_view1() {
		super(0);

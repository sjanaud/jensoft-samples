...
/**
 * <code>Donut3DPlugin_Label_Radial_view2</code>
 * 
 * @author JenSoftAPI
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use radial label on donut3D slice.")
public class Donut3DPlugin_Label_Radial_view2 extends View {

	private static final long serialVersionUID = -4839355997728730207L;

	/**
	 * Create Donut3D radial label demo
	 */
	public Donut3DPlugin_Label_Radial_view2() {
		super(0);
		...
		// DONUT
		// create donut
		Donut3D donut3d = Donut3DToolkit.createDonut3D("myDonut", 70, 120, 60, 300, 70);
		donut3DPlugin.addDonut(donut3d);

		donut3d.setStartAngleDegree(70);

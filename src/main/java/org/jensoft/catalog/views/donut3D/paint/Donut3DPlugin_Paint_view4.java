...
/**
 * <code>Donut3DPlugin_Paint_view4</code>
 * 
 * @author JenSoftAPI
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to paint for donut3D.")
public class Donut3DPlugin_Paint_view4 extends View {

	private static final long serialVersionUID = -2871388001149835433L;

	/**
	 * Create Donut3D radial label demo
	 */
	public Donut3DPlugin_Paint_view4() {
		super(0);
		...
		s1.setThemeColor(new Alpha(s1.getThemeColor(),100));
		s2.setThemeColor(new Alpha(s2.getThemeColor(),100));
		s4.setThemeColor(new Alpha(s4.getThemeColor(),100));

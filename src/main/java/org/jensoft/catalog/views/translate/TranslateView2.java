...
public class TranslateView2 extends View {
	...
	private static final long serialVersionUID = 7072991332608245209L;
	
	/**expose translate to dashboard*/
	private TranslatePlugin translate;

	public TranslateView2() {
		...
		compass.setRingFillColor(new Alpha(RosePalette.LEMONPEEL, 150));
		...
		double[] yValues = {2, 8, 3, 1, 7, 4, 10, 6, 1, 6, 12, 0, 5, 2 };

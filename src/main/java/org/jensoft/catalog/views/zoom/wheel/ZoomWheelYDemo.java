...
/**
 * <code>ZoomWheelYDemo</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class)
public class ZoomWheelYDemo extends View {

	/** font demo */
	private Font font = new Font("lucida console", Font.PLAIN, 10);

	/**
	 * Create a demo with programmatically zoom wheel process on y dimension
	 */
	public ZoomWheelYDemo() {
		...
		wheel.setZoomWheelType(ZoomWheelType.ZoomY);

...
@JenSoftView(background=ViewDarkBackground.class,description="a zoom box (view 1) view which is use in zoom box synchronization demo, see SynchronizedZoomBox Dashboard.",ignore=true)
public class BoxView1 extends View {
	...
	public BoxView1() {
		...
		TitleLegend l1 = TitleLegendPlugin.createLegend("Zoom Box Synchronizer", RosePalette.COALBLACK, RosePalette.MANDARIN);

...
@JenSoftView(background=ViewDarkBackground.class,description="a zoom lens (view 2) view which is use in zoom lens synchronization demo, see SynchronizedZoomLens Dashboard.",ignore=true)
public class ObjectifView2 extends View {

	private ZoomLensPlugin objectif;

	public ObjectifView2() {

...
/**
 * <code>ZoomBoxDonutWidgetDemo</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class)
public class ZoomBoxDonutWidgetDemo extends View {

	/** font demo */
	private Font font = new Font("lucida console", Font.PLAIN, 10);

	/**
	 * Create demo with a zoom box and widget history
	 */
	public ZoomBoxDonutWidgetDemo() {
		super();
		setPlaceHolder(100);

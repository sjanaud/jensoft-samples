...
/**
 * <code>ZoomWheelProgrammaticallyDemo</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class)
public class ZoomWheelProgrammaticallyDemo extends View {

	/** font demo */
	private Font font = new Font("lucida console", Font.PLAIN, 10);

	/**
	 * Create a demo with programmatically zoom wheel process
	 */
	public ZoomWheelProgrammaticallyDemo() {
		super();
		...
		final ZoomWheelPlugin wheel = new ZoomWheelPlugin();

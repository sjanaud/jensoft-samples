...
@JenSoftView(background=ViewDarkBackground.class,description="a zoom wheel (view 2) view which is use in zoom wheel synchronization demo, see SynchronizedZoomWheel Dashboard.",ignore=true)
public class WheelView2 extends View {

	private ZoomWheelPlugin zoomWheel2;
	...
	public WheelView2() {
		...
		ZoomBoxPlugin zoomBox2 = new ZoomBoxPlugin();
		zoomBox2.setThemeColor(Color.RED);
		// ZoomBoxBarWidget w1 = new ZoomBoxBarWidget();
		ZoomBoxDonutWidget w2 = new ZoomBoxDonutWidget();
		zoomBox2.registerWidget(w2);

		proj.registerPlugin(zoomBox2);

		zoomWheel2 = new ZoomWheelPlugin();
		proj.registerPlugin(zoomWheel2);
	}

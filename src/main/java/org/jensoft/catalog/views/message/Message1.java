 ...
 */
package org.jensoft.catalog.views.message;
...
import org.jensoft.core.plugin.message.MessageDefaultDeviceContext;
import org.jensoft.core.plugin.message.MessagePlugin;
import org.jensoft.core.plugin.message.MessageSelecterWidget;
...
public class Message1 extends View {
	...
	public Message1() {
		...
		proj.setThemeColor(RosePalette.EMERALD.brighter());

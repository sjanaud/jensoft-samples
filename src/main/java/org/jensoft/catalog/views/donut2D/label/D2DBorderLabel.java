...
/**
 * <code>D2DBorderLabel</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to create border label on donut2D.")
public class D2DBorderLabel extends View {

	private static final long serialVersionUID = -7544587156041376287L;

	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new D2DBorderLabel());
	}
	
	/**
	 * create Donut2D demo with border label
	 */
	public D2DBorderLabel() {
		super(0);
		...
		Donut2DBorderLabel label1 = Donut2DToolkit.createBorderLabel("BorderLabel", RosePalette.COALBLACK, f, 20, Style.Both);

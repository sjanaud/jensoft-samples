...
/**
 * <code>D2DRadialFill</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to radial fill donut2D.")
public class D2DRadialFill extends View {

	private static final long serialVersionUID = 1149416072854649835L;

	/**
	 * create Donut2D demo with radial slice fill
	 */
	public D2DRadialFill() {
		super(0);
	...
	public static View getPortofolio() {
		D2DRadialFill demo = new D2DRadialFill();

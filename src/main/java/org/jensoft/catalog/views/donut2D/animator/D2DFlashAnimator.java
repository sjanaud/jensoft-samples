...
import org.jensoft.core.plugin.donut2d.animator.Donut2DFlashAnimator;
...
/**
 * <code>D2DFlashAnimator</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use flash animator on donut2D slice.")
public class D2DFlashAnimator extends View {

	private static final long serialVersionUID = 480652505301224823L;

	/**
	 * create donut2D demo with flash animator on mouse slice clicked
	 */
	public D2DFlashAnimator() {
		super();
		...
		donut1.addDonutAnimator(new Donut2DFlashAnimator());

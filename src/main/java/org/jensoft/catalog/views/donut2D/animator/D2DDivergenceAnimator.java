...
import org.jensoft.core.plugin.donut2d.animator.Donut2DDivergenceAnimator;
...
/**
 * <code>D2DDivergenceAnimator</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use divergence animator on donut2D slice.")
public class D2DDivergenceAnimator extends View {

	private static final long serialVersionUID = -7616871535053183506L;

	/**
	 * create a donut2D demo with slice divergence on mouse click
	 */
	public D2DDivergenceAnimator() {
		super();
		...
		donut1.addDonutAnimator(new Donut2DDivergenceAnimator(60, 2));

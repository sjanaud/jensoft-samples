...
import org.jensoft.core.plugin.donut2d.animator.Donut2DAlphaAnimator;
...
/**
 * <code>D2DAlphaAnimator</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to use alpha animator on donut2D slice.")
public class D2DAlphaAnimator extends View {

	private static final long serialVersionUID = -1445989287787164346L;

	/**
	 * create Donut2D demo with slice alpha transition on slice mouse click
	 */
	public D2DAlphaAnimator() {
		super();
		...
		donut1.addDonutAnimator(new Donut2DAlphaAnimator());

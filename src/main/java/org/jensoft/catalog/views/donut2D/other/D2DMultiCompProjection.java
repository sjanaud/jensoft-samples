...
/**
 * <code>D2DMultiCompProjection<code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewNoBackground.class,description="Show how to create multiple donut2D in the projection component system.")
public class D2DMultiCompProjection extends View {

	private static final long serialVersionUID = -2685830792955369556L;

	/**
	 * Create a donut2D demo with 3 Donut2D which are projected in the component
	 * projection
	 */
	public D2DMultiCompProjection() {
		super();
		...
		donut1.setCenterX(150);
		donut1.setCenterY(150);
		donut1.setInnerRadius(70);
		donut1.setOuterRadius(100);
		donut1.setStartAngleDegree(50);
		donut1.setExplose(5);

		Donut2DSlice s1 = new Donut2DSlice("s1", new Color(139, 196, 40));
		s1.setAlpha(0.5f);
		s1.setValue(20.0);

		Donut2DSlice s2 = new Donut2DSlice("s2", new Color(213, 222, 35));
		s2.setValue(20.0);
		s2.setAlpha(0.5f);

		Donut2DSlice s3 = new Donut2DSlice("s3", new Color(78, 148, 44));
		s3.setValue(20.0);
		s3.setAlpha(0.5f);
		...
		donut2.setCenterX(400);
		donut2.setCenterY(150);
		donut2.setInnerRadius(70);
		donut2.setOuterRadius(100);
		donut2.setStartAngleDegree(120);
		donut2.setExplose(7);

		Donut2DSlice s4 = new Donut2DSlice("s4", new Color(0, 176, 217));
		s4.setValue(30.0);
		s4.setAlpha(0.4f);

		Donut2DSlice s5 = new Donut2DSlice("s5", new Color(174, 221, 227));
		s5.setValue(10.0);
		s5.setAlpha(0.7f);

		Donut2DSlice s6 = new Donut2DSlice("s6", new Color(28, 152, 183));
		s6.setValue(20.0);
		s6.setAlpha(0.7f);
		...
		donut3.setCenterX(650);
		donut3.setCenterY(150);
		donut3.setInnerRadius(70);
		donut3.setOuterRadius(100);
		donut3.setStartAngleDegree(120);
		donut3.setExplose(7);

		Donut2DSlice s7 = new Donut2DSlice("S7", new Color(240, 90, 40));
		s7.setValue(40.0);
		s7.setAlpha(0.7f);

		Donut2DSlice s8 = new Donut2DSlice("s8", new Color(251, 148, 9));
		s8.setValue(25);
		s8.setAlpha(0.7f);

		Donut2DSlice s9 = new Donut2DSlice("s9", new Color(251, 174, 66));
		s9.setValue(25);
		s9.setAlpha(0.5f);
	 ...
	 * {@link #Donut2DMultipleComponentProjectionDemo()}
	 * 
	 * @return portfolio view
	 */
	@Portfolio(name = "Donut2DMultipleComponentProjectionDemo", width = 800, height = 600)
	public static View getPortofolio() {
		D2DMultiCompProjection demo = new D2DMultiCompProjection();

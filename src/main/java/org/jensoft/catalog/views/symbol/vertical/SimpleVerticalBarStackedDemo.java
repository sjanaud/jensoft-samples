...
public class SimpleVerticalBarStackedDemo extends View {

	public static void main(String[] args) {
		ViewFrameUI ui = new ViewFrameUI(new SimpleVerticalBarStackedDemo());
	}
	
	@Portfolio(name = "SimpleVerticalBarStackedDemo22", width = 500, height = 250)
	public static View getPortofolio() {
		SimpleVerticalBarStackedDemo demo = new SimpleVerticalBarStackedDemo();
	...
	public SimpleVerticalBarStackedDemo() {
		...
		s2b1.setBarEffect(new BarEffect1());

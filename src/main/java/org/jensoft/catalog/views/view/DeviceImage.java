...
import org.jensoft.core.plugin.background.DeviceImageBackgroundPlugin;
...
/**
 * <code>DeviceImage</code>
 * 
 * @author Sébastien Janaud
 */
@JenSoftView(background=ViewDarkBackground.class,description="Display device image background")
public class DeviceImage extends View {
	 ...
	 */
	@Portfolio(name = "DeviceImage", width = 600, height = 400)
	public static View getPortofolio() {
		DeviceImage demo = new DeviceImage();
	...
	public DeviceImage() {
		...
		try {
			iis = this.getClass().getResourceAsStream("space.jpg");
			BufferedImage bi = ImageIO.read(iis);
			DeviceImageBackgroundPlugin bgPlugin = new DeviceImageBackgroundPlugin(bi);
